...
#ifndef CLANREALMS_SWIFT_H
#define CLANREALMS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClanRealms",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class UIWindow;
SWIFT_CLASS("_TtC10ClanRealms11AppDelegate")
...
SWIFT_CLASS("_TtC10ClanRealms10ArenaScene")
...
SWIFT_CLASS("_TtC10ClanRealms12ChampionNode")
@interface ChampionNode : SKNode
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10ClanRealms13StructureNode")
@interface StructureNode : SKNode
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10ClanRealms8UnitNode")
@interface UnitNode : SKNode
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
